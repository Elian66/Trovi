...
public class CDB {
    ...
    public void readDB(){
        ...
        String completePathB = "cdb."+Globals.LINE_LOCATION+"."+Globals.LINE_CONNECTION+"/brightCollect.txt";
        String completePathC = "cdb."+Globals.LINE_LOCATION+"."+Globals.LINE_CONNECTION+"/ringCollect.txt";
