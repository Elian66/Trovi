...
public class FDB {
    ...
    public void readDB(){
        ...
        String completePathA = "fdb."+Globals.LINE_LOCATION+"."+Globals.LINE_TIME+"."+Globals.LINE_BATTERY+"/volumeCollect.txt";
        String completePathB = "fdb."+Globals.LINE_LOCATION+"."+Globals.LINE_TIME+"."+Globals.LINE_BATTERY+"/brightCollect.txt";
        String completePathC = "fdb."+Globals.LINE_LOCATION+"."+Globals.LINE_TIME+"."+Globals.LINE_BATTERY+"/ringCollect.txt";
    ...
    public String getMedian(List<Integer> m) {
        int middle = m.size()/2;
        if (m.size()%2 == 1) {
            return Double.toString(m.get(middle));
        } else {
            int median = (int) (m.get(middle-1) + m.get(middle)) / 2;
    ...
    public String getModa(List<Integer> listA) {
        ...
        for (int i = 0; i < listA.size(); ++i) {
            ...
            Log.d("RAWDATA","Moda"+listA.get(i));
