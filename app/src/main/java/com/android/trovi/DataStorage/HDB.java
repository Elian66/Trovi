...
public class HDB {
    public void createDB(){
        ...
        String completePath = "hdb."+ Globals.LINE_LOCATION+"."+Globals.LINE_HEADPHONE+"/";

        String directory_path = Environment.getExternalStorageDirectory().getPath()
                + "/Documents/Trovi/Users/Logs/HDB/"+completePath;
    ...
    public void readDB(){
        ...
        String completePathB = "hdb."+Globals.LINE_LOCATION+"."+Globals.LINE_HEADPHONE+"/brightCollect.txt";
        String completePathC = "hdb."+Globals.LINE_LOCATION+"."+Globals.LINE_HEADPHONE+"/ringCollect.txt";
        ...
        final File fileb = new File(Environment.getExternalStorageDirectory().getPath()
                + "/Documents/Trovi/Users/Logs/HDB/"+completePathB);

        final File filec = new File(Environment.getExternalStorageDirectory().getPath()
                + "/Documents/Trovi/Users/Logs/HDB/"+completePathC);
