...
//bDB		(Locate/BatteryDB)			(3)
public class BDB {
    public void createBDB(){
    ...
    public void readBDB(){
        ...
        String completePathB = "bdb."+Globals.LINE_LOCATION+"."+Globals.LINE_BATTERY+"/brightCollect.txt";
        String completePathC = "bdb."+Globals.LINE_LOCATION+"."+Globals.LINE_BATTERY+"/ringCollect.txt";
